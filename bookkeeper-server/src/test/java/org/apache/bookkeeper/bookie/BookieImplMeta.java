...
public class BookieImplMeta extends BookieImpl {
        private static final Logger log = LoggerFactory.getLogger(BookieImplMeta.class);

        private final Resources resources;

        public BookieImplMeta(ServerConfiguration conf) throws Exception {
                this(new ResourceBuilder(conf).build());
        }

        public BookieImplMeta(@NotNull Resources resources) throws Exception {
